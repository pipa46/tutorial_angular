...
import { Autor } from 'src/app/author/Author';
...
export class GameEditComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.authorService.getAllAutores().subscribe(
            authors => {
                this.authors = authors

                if (this.data.game.author != null) {
                    let authorFilter: Autor[] = authors.filter(author => author.id == this.data.game.author.id);
